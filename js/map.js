...
function initialize() {
			...
			*/
			...
			var Y_point			= 37.612547;		// Y 좌표 (위도)
			var X_point			= 127.0453501;		// X 좌표 (경도)

			var zoomLevel		= 15;						// 첫 로딩시 보일 지도의 확대 레벨

			var markerTitle		= "서울시 중랑구 묵동";		 // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
			...
			var contentString	= '<div id="content">' +
					...
					'<div id="bodyContent">'+ 
						'<p>집입니다!. <br /><a href="http:/www.ezen.co.kr" target="_blank">http:/www.ezen.co.kr</a></p>'+	
					'</div>'+ 
				'</div>';
